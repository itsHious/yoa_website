...
@section('content')
    ...
    <div class="our-conpamy-history rts-section-gapTop">
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
                    <div class="title-style-two left text-center">
                        <h2 class="title rts-text-anime-style-1">Empowering Minds. Transforming Systems.
                        </h2>
                        {{-- <p class="disc">
                            Dabus nisl aliquet congue tellus nascetur lectus sagpien mattis arcu dictums augue volutpat
                            felis etiam
                        </p> --}}
                        <img class="mt--70 shape-iamge-line" src="{{ asset('website/assets/images/banner/personal.jpg') }}" alt="appoinment">
                        <img class="mt--20 shape-iamge-line" src="{{ asset('website/assets/images/about/shape/01.png')}}" alt="shape" class="three">
                    </div>
                </div>
                <div class="col-lg-7">
                    <div class="company-history-main-wrapper">
                        <div class="single-company-history shadow border bg">
                            <div class="">
                                {{-- <h5 class="title">Elevate Web Design</h5> --}}
                                <p class="disc text-justify text-white">
    ...
    <div class="rts-service-area pt--40 pb--60 border">
                        ...
                        <div class="row">
                            <div class="col-lg">
                                <div class="title-style-four text-center">
                                    ...
                                    <h5 class="title rts-text-anime-style-2"> Our Core <span>Values</span></h5>
                                </div>
